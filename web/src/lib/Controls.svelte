<script lang="ts">
    ...
    function isKeyboardSelected(): boolean {
        return source === keyboard;
    }

    function isGamepadSelected(): boolean {
...
<div class="input-method-selector">
    <button
            class="method-button"
            on:click={setKeyboard}
            class:selected={isKeyboardSelected()}
            class:unselected={!isKeyboardSelected()}
    >
    ...
    <button
            class="method-button"
            on:click={setGamepad}
            class:selected={isGamepadSelected()}
            class:unselected={!isGamepadSelected()}
    >
